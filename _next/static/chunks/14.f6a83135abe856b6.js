...
class Factory extends web/* SmartContract */.C3 {
    ...
    */ async work(secretmap) {
    ...
    async changeMap(x, y, value, secretmap) {
        ...
        for(let i = 0; i < 7; i++){
            for(let j = 0; j < 7; j++){
                let f = web/* Provable */.PC.if(web/* Bool */.tW.and(x.equals(i), y.equals(j)), value, secretmap.gamemap[i].values[j]);
                h = web/* Poseidon */.jm.hash([
                    h,
                    f
                ]);
...
class zkappWorker_Line extends (0,web/* Struct */.AU)({
    values: [
        web/* Field */.gN,
        web/* Field */.gN,
        web/* Field */.gN,
...
class zkappWorker_Gamemap extends (0,web/* Struct */.AU)({
    gamemap: [
        zkappWorker_Line,
        zkappWorker_Line,
        zkappWorker_Line,
...
const gameStruct = new zkappWorker_Gamemap({
    gamemap: [
        new zkappWorker_Line({
            values: [
                (0,web/* Field */.gN)(7),
                (0,web/* Field */.gN)(1),
                (0,web/* Field */.gN)(0),
...
const api = {
    ...
    async getHash () {
        var _state_zkappInstance;
        const currentHash = await ((_state_zkappInstance = state.zkappInstance) === null || _state_zkappInstance === void 0 ? void 0 : _state_zkappInstance.hash_of_array.fetch());
        return currentHash === null || currentHash === void 0 ? void 0 : currentHash.toString();
    },
    async getCoins () {
        var _state_zkappInstance;
        const currentCoins = await ((_state_zkappInstance = state.zkappInstance) === null || _state_zkappInstance === void 0 ? void 0 : _state_zkappInstance.coins.get());
        return currentCoins === null || currentCoins === void 0 ? void 0 : currentCoins.toString();
    },
    async work (gameArr) {
        const senderAccount = state.Mina.testAccounts[1];
        const senderKey = senderAccount.key;
        for(let i = 0; i < 49; i++){
            gameStruct.gamemap[parseInt((i / 7).toString())].values[i % 7] = (0,web/* Field */.gN)(gameArr[i]);
        }
        const txn1 = await web/* Mina */.No.transaction(senderAccount, async ()=>{
            var _state_zkappInstance;
            await ((_state_zkappInstance = state.zkappInstance) === null || _state_zkappInstance === void 0 ? void 0 : _state_zkappInstance.work(gameStruct));
        });
        await txn1.prove();
        console.log("Proven");
        await txn1.sign([
    ...
    async changeMap (i, j, value, gameArr) {
        const senderAccount = state.Mina.testAccounts[1];
        const senderKey = senderAccount.key;
        const txn1 = await web/* Mina */.No.transaction(senderAccount, async ()=>{
            var _state_zkappInstance;
            await ((_state_zkappInstance = state.zkappInstance) === null || _state_zkappInstance === void 0 ? void 0 : _state_zkappInstance.changeMap((0,web/* Field */.gN)(i), (0,web/* Field */.gN)(j), (0,web/* Field */.gN)(value), gameStruct));
        });
        await txn1.prove();
        console.log("Proven");
        await txn1.sign([
...
/******/ 			if (chunkId === 917) return "static/chunks/e6142f45-8ccfccaa7bcb9e72.js";
/******/ 			// return url for filenames based on template
/******/ 			return "static/chunks/" + chunkId + "." + "2142be7bb27d65d2" + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
