...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3605));
...
class Game_Line extends (0,web/* Struct */.AU)({
    values: [
        web/* Field */.gN,
        web/* Field */.gN,
        web/* Field */.gN,
...
class Game_Gamemap extends (0,web/* Struct */.AU)({
    gamemap: [
        Game_Line,
        Game_Line,
        Game_Line,
...
const Game = (param)=>{
    let { zkappWorkerClient, gameMap, setGameMap, setCurrentHash, setCurrentCoins, ready, setReady, displayStep } = param;
        ...
        const work = async ()=>{
            if (active && zkappWorkerClient != null) {
                try {
                    ...
                    let c = await (zkappWorkerClient === null || zkappWorkerClient === void 0 ? void 0 : zkappWorkerClient.work(gameMap));
                    let a = await (zkappWorkerClient === null || zkappWorkerClient === void 0 ? void 0 : zkappWorkerClient.getCoins());
    ...
    (0,react.useEffect)(()=>{
        const changeMap = async ()=>{
            ...
            if (i > 0) {
                await (zkappWorkerClient === null || zkappWorkerClient === void 0 ? void 0 : zkappWorkerClient.changeMap(parseInt((i / 7).toString()), i % 7, gameMap[i], gameMap));
                let a = await (zkappWorkerClient === null || zkappWorkerClient === void 0 ? void 0 : zkappWorkerClient.getHash());
                setCurrentHash(a);
            }
...
function Home() {
    ...
    const [currentHash, setCurrentHash] = (0,react.useState)("");
    const [currentCoins, setCurrentCoins] = (0,react.useState)("");
        ...
        const setup = async ()=>{
            try {
                if (!hasBeenSetup) {
                    ...
                    setCurrentHash(hash);
                    const coins = await (zkappWorkerClient === null || zkappWorkerClient === void 0 ? void 0 : zkappWorkerClient.getCoins());
            ...
            children: [
                /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                        ...
                        mainContent,
                        "Current Hash of the map:  ",
                        (currentHash === null || currentHash === void 0 ? void 0 : currentHash.slice(0, 10)) + "..." + (currentHash === null || currentHash === void 0 ? void 0 : currentHash.slice(70)),
...
/******/ __webpack_require__.O(0, [357,917,391,971,23,744], function() { return __webpack_exec__(3784); });
